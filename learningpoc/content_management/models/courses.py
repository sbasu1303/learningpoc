...
class Course(models.Model):
    ...
    author = models.ForeignKey(to=LappUser, on_delete=models.PROTECT, null=False, blank=False, related_name='author')
    adminApprover = models.ForeignKey(to=LappUser, null=True, blank=True, related_name='approver')
